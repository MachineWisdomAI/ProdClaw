...
// NOTE: the upstream test "passes the resolved shared config into the tts
// tool" was dropped from this cherry-pick because it depends on a
// post-baseline TTS config refactor (resolveSharedTtsConfig). The MK-52 fix
// (currentDeliveryContext on the cron tool) is exercised below.
